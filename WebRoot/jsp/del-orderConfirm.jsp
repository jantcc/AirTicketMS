...
<header>
    ...
    <div align="right">
        <p>欢迎您,
            <s:if test='#session.user.authority=="1"'>
                管理员
            </s:if>
            <s:else>高级管理员</s:else>
...
<div class="container">
    ...
    <div class="content">
        ...
        <div class="content-title alreadyPlants">
            ...
            <h2 style="color: #0163c6; float: left; margin: 30px 0 0 10px">退票审核</h2>
        </div>

        <div class="table-container">
            <div class="table-container-header"><span>待处理订单</span></div>
            <table class="table-form" border=0 cellspacing=0 cellpadding=0>
               ...
               <s:iterator value="#session.list" id="order">
                    ...
                    <td>
                        <div style="width: 20px; margin: 0 auto"><a href="delorder?id=<s:property value="#order.id"/>"><i class="iconfont" style="color: #0967c7">&#xe60e;</i></a>
                           </div>
                    </td>
                </tr>
                </s:iterator>
